 ...
 *   <li>{@link de.dentrassi.varlink.idl.varlinkIdl.impl.FieldImpl#isMulti <em>Multi</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FieldImpl extends MinimalEObjectImpl.Container implements Field
{
  ...
  public void setMulti(boolean newMulti)
  {
    ...
    multi = newMulti;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, VarlinkIdlPackage.FIELD__MULTI, oldMulti, multi));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      ...
      case VarlinkIdlPackage.FIELD__TYPE:
        return getType();
      case VarlinkIdlPackage.FIELD__MULTI:
        return isMulti();
    }
